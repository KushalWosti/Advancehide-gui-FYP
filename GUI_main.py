...
def login_window():
    ...
    heading = Label(root, text="Welcome to Advance hide", bg="SpringGreen2")
...
def signup_window():
    ...
    l_welcome = Label(top, text="Welcome to Advance hide", bg="SpringGreen2")
...
def last_window(file, flag_file):
    ...
    lwin.configure(background="SpringGreen2")
...
def img_steg_window(username, flag, uuid):
    ...
    iwin.configure(background="SpringGreen2")
...
def audio_steg_window(username,flag,uuid):
    ...
    awin.configure(background="SpringGreen2")
...
def user_mgmt(username, flag, uuid, win):
    ...
    admin_win.configure(background="SpringGreen2")
